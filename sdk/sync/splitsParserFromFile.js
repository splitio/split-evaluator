// For tests purposes, we allow loading feature flag mocks from a local file.

const fs = require('fs');
const path = require('path');
const yaml = require('js-yaml');
const { isString, endsWith, find, forOwn, uniq } = require('@splitsoftware/splitio-commons/cjs/utils/lang');
const { parseCondition } = require('@splitsoftware/splitio-commons/cjs/sync/offline/splitsParser/parseCondition');
